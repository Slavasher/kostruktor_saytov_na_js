...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/nurburgring.jpg":[function(require,module,exports) {
module.exports = "/nurburgring.c19b6eef.jpg";
},{}],"assets/24h.jpg":[function(require,module,exports) {
module.exports = "/24h.c6932db1.jpg";
...
var _nurburgring = _interopRequireDefault(require("./assets/nurburgring.jpg"));

var _h = _interopRequireDefault(require("./assets/24h.jpg"));
...
var model = [new _blocks.TitleBlock('Нюрбургринг Нордшляйф', {
  tag: 'h2',
  styles: {
...
}), new _blocks.ImageBlock(_nurburgring.default, {
  styles: {
    padding: '2rem 0',
    display: 'flex',
  ...
  alt: 'Это картинка'
}), new _blocks.ColumnsBlock(['«Нюрбургринг - это нечто! <br> Грандиозная трасса, где есть возможность получить новые незабываемые впечатления даже на таком простом автомобиле, как Renault Clio RS.', '«Никогда не думал, что в поворотах на скорости за 150 км/ч может быть такой держак. Автомобиль в буквальном смысле проходит повороты и шиканы, как по рельсам.', '«Огромное спасибо организаторам за возможность побывать на Нюрбургринге.'], {
  styles: {
...
}), new _blocks.ImageBlock(_h.default, {
  styles: {
    padding: '2rem 0',
    display: 'flex',
    'justify-content': 'center'
...
exports.model = model;
},{"./assets/nurburgring.jpg":"assets/nurburgring.jpg","./assets/24h.jpg":"assets/24h.jpg","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
